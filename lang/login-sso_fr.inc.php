...
$GLOBALS['translations'] = array_merge(
    ...
    array(
        ...
        'SSO_USER_EMAIL_REQUIRED' => 'Le paramètre \'email_sso_field\' permettant de faire le lien avec un compte YesWiki doit être renseigné dans le fichier de configuration',
